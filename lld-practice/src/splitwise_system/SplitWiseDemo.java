package splitwise_system;

import splitwise_system.entities.Expense;
import splitwise_system.entities.Group;
import splitwise_system.entities.Transaction;
import splitwise_system.entities.User;
import splitwise_system.strategy.EqualSplitStrategy;
import splitwise_system.strategy.ExactSplitStrategy;
import splitwise_system.strategy.PercentageSplitStrategy;
...
public class SplitWiseDemo {
    public static void main(String[] args) {
        ...
        User charlie = service.addUser("Charlie", "charlie@e.com");
